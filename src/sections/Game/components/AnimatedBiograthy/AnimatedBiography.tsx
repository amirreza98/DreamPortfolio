...
const AnimatedBiography = () => {
  ...
  const text = `Hello, my name is AmirReza Azemati. My journey began in Iran, where I worked with Foolad Zarand Co. and first discovered my fascination with digital twins. How powerful was this experience connection between the physical and digital worlds. That experience sparked something in me.<br/>
  ...
  const text_de = `Hallo, mein Name ist AmirReza Azemati. Meine Reise begann im Iran, wo ich bei Foolad Zarand Co. arbeitete und zum ersten Mal meine Faszination für digitale Zwillinge entdeckte – die kraftvolle Verbindung zwischen der physischen und der digitalen Welt. Diese Erfahrung hat in mir etwas entfacht.<br/>
